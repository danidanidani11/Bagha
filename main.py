...
if not os.path.exists(QUESTIONS_FILE):
  ...
  {
    "question": "🌡️ [مرحله 91] تب شدیدی دارید و بدن شما داغ شده است. چه کاری انجام می‌دهید؟",
    "options": ["💊 از داروهای تب‌بر استفاده می‌کنم", "❄️ با آب سرد بدنم را خنک می‌کنم", "🛌 استراحت می‌کنم و آب می‌نوشم", "🔥 نزدیک آتش می‌مانم تا عرق کنم"],
    "answer": 2,
    "explanations": {
      "0": "داروهای تب‌بر ممکن است در دسترس نباشند.",
      "1": "خنک کردن سریع بدن با آب سرد ممکن است خطرناک باشد.",
      "2": "✅ استراحت و نوشیدن آب به کاهش تب کمک می‌کند.",
      "3": "نزدیک آتش ماندن وضعیت را بدتر می‌کند."
    }
  },
  {
    "question": "🪓 [مرحله 92] برای قطع یک درخت کوچک به چوب نیاز دارید. بهترین روش چیست؟",
    "options": ["🪓 با تبر دست‌ساز درخت را قطع می‌کنم", "🔥 آتش پای درخت روشن می‌کنم", "🔄 از درختان افتاده استفاده می‌کنم", "⏳ صبر می‌کنم تا باد درخت را بیندازد"],
    "answer": 0,
    "explanations": {
      "0": "✅ استفاده از تبر یا ابزار تیز مؤثرترین راه است.",
      "1": "سوزاندن درخت زمان‌بر و خطرناک است.",
      "2": "استفاده از درختان افتاده گزینه خوبی است، اما ممکن است همیشه وجود نداشته باشد.",
      "3": "صبر کردن بدون اقدام منطقی نیست."
    }
  },
  {
    "question": "🌊 [مرحله 93] به یک رودخانه خروشان برخورد کرده‌اید. چگونه از آن عبور می‌کنید؟",
    "options": ["🏊 شنا می‌کنم", "🌉 به دنبال پل یا منطقه کم‌عمق می‌گردم", "🪵 با تنه درخت از رودخانه رد می‌شوم", "🚶 از مسیر دیگری می‌روم"],
    "answer": 1,
    "explanations": {
      "0": "شنا در رودخانه خروشان بسیار خطرناک است.",
      "1": "✅ یافتن منطقه امن‌تر بهترین راه است.",
      "2": "استفاده از تنه درخت ممکن است تعادل را به هم بزند.",
      "3": "تغییر مسیر همیشه امکان‌پذیر نیست."
    }
  },
  {
    "question": "🐝 [مرحله 94] زنبورهای وحشی به شما حمله کرده‌اند. چه واکنشی نشان می‌دهید؟",
    "options": ["🏃 سریع فرار می‌کنم", "🔥 با دود آن‌ها را دور می‌کنم", "🛌 روی زمین می‌خوابم", "📢 فریاد می‌زنم"],
    "answer": 2,
    "explanations": {
      "0": "فرار ممکن است زنبورها را عصبانی‌تر کند.",
      "1": "دود مؤثر است اما زمان‌بر.",
      "2": "✅ دراز کشیدن و پوشاندن سر بهترین راه برای کاهش گزیدگی است.",
      "3": "فریاد زدن بی‌فایده است."
    }
  },
  {
    "question": "🌫️ [مرحله 95] مه غلیظی دید شما را محدود کرده است. چه می‌کنید؟",
    "options": ["🚶 به مسیر ادامه می‌دهم", "📍 با طناب خود را به درخت می‌بندم تا گم نشوم", "🔥 آتش روشن می‌کنم تا مه کم شود", "🛌 صبر می‌کنم تا مه از بین برود"],
    "answer": 1,
    "explanations": {
      "0": "ادامه حرکت در مه خطر گم‌شدگی دارد.",
      "1": "✅ بستن خود به یک نقطه ثابت از گم شدن جلوگیری می‌کند.",
      "2": "آتش تأثیری روی مه ندارد.",
      "3": "صبر کردن ممکن است زمان زیادی ببرد."
    }
  },
  {
    "question": "🦉 [مرحله 96] شب است و صدای حیوانات وحشی می‌شنوید. چگونه آرامش خود را حفظ می‌کنید؟",
    "options": ["🔥 آتش را بزرگ‌تر می‌کنم", "🔦 با چراغ قوه اطراف را بررسی می‌کنم", "🎵 برای خود آواز می‌خوانم", "🛌 در پناهگاه می‌مانم و سکوت می‌کنم"],
    "answer": 0,
    "explanations": {
      "0": "✅ آتش بزرگ‌تر حیوانات را دور نگه می‌دارد.",
      "1": "نور ممکن است حیوانات را تحریک کند.",
      "2": "صداهای بلند ممکن است خطرناک باشد.",
      "3": "سکوت خوب است، اما آتش امنیت بیشتری دارد."
    }
  },
  {
    "question": "🏞️ [مرحله 97] به یک منطقه باتلاقی رسیده‌اید. چگونه از آن عبور می‌کنید؟",
    "options": ["🚶 با احتیاط از کنار باتلاق رد می‌شوم", "🪵 از چوب برای تست عمق استفاده می‌کنم", "🏃 سریع از روی آن می‌پرم", "🔄 مسیر را تغییر می‌دهم"],
    "answer": 1,
    "explanations": {
      "0": "حرکت بدون بررسی ممکن است باعث فرو رفتن در باتلاق شود.",
      "1": "✅ تست عمق با چوب ایمن‌ترین راه است.",
      "2": "پریدن خطرناک است و ممکن است در گل فروروید.",
      "3": "تغییر مسیر همیشه امکان‌پذیر نیست."
    }
  },
  {
    "question": "🌅 [مرحله 98] طلوع آفتاب است و باید مسیر خود را انتخاب کنید. کدام جهت بهتر است؟",
    "options": ["☀️ به سمت شرق (به سوی خورشید)", "🌲 به سمت جنگل انبوه", "🏔️ به سمت کوه‌ها", "🌊 به سمت رودخانه"],
    "answer": 0,
    "explanations": {
      "0": "✅ حرکت به سمت شرق (محل طلوع خورشید) جهت‌یابی را آسان‌تر می‌کند.",
      "1": "جنگل انبوه ممکن است مسیر را سخت کند.",
      "2": "کوه‌نوردی انرژی زیادی می‌برد.",
      "3": "رودخانه ممکن است به مناطق خطرناک منتهی شود."
    }
  },
  {
    "question": "🪨 [مرحله 99] یک غار برای استراحت پیدا کرده‌اید. قبل از ورود چه می‌کنید؟",
    "options": ["🔥 آتش روشن می‌کنم تا حیوانات فرار کنند", "🔦 با چراغ قوه داخل را بررسی می‌کنم", "🚶 بدون بررسی وارد می‌شوم", "🛑 از ورود خودداری می‌کنم"],
    "answer": 1,
    "explanations": {
      "0": "آتش ممکن است دود را در غار حبس کند.",
      "1": "✅ بررسی داخل غار از مواجهه با حیوانات خطرناک جلوگیری می‌کند.",
      "2": "ورود بدون بررسی بسیار خطرناک است.",
      "3": "غار می‌تواند پناهگاه خوبی باشد، اما باید ایمن باشد."
    }
  },
  {
    "question": "🎉 [مرحله 100] تیم نجات شما را پیدا کرده است! اولین کاری که می‌کنید چیست؟",
    "options": ["📞 با خانواده تماس می‌گیرم", "💧 آب می‌نوشم", "🏥 وضعیت سلامتی خود را چک می‌کنم", "🍫 غذایی انرژی‌زا می‌خورم"],
    "answer": 2,
    "explanations": {
      "0": "تماس مهم است، اما سلامت شما اولویت دارد.",
      "1": "نوشیدن آب ضروری است، اما ابتدا باید از سلامت خود مطمئن شوید.",
      "2": "✅ بررسی وضعیت جسمانی پس از نجات بسیار مهم است.",
      "3": "خوردن غذا مهم است، اما ابتدا باید آسیب‌ها را بررسی کرد."
    }
  }
]
